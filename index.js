...
const instagram = 'https://www.instagram.com/jamer.fvnky/'; // JANGAN UBAH-UBAH INFO!!!
const nomer = 'wa.me/6285735054693'; // JANGAN UBAH-UBAH INFO!!!
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @Jamer.Fnky_`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @Jamer.Fnkyl_`)
})
...
conn.sendMessage(id, ' *Owner Yudhitya wa.me/6285735054693* ' ,MessageType.text);
}
else if (text == '#help'){
...
conn.sendMessage(id, ' *Creator Jamer.Fnky wa.me/6285735054693* ' ,MessageType.text);
}
else if (text == 'Pagi'){
  ...
  var aris = text.replace(/.nulis /, '')
    ...
    .then((res) => {
      imageToBase64(res.data.result)
        .then(
          (ress) => {
            conn.sendMessage(id, '[WAIT] Tunggu Beb:v...', MessageType.text)
...
axios.get(`https://alfians-api.herokuapp.com/api/yta?url=${aris}`).then((res) => {
	conn.sendMessage(id, '[WAIT] Hmmm...', MessageType.text)
...
conn.sendMessage(id, help.help(id, A187, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwhatsapp) ,MessageType.text);
}
if (text == '#menu'){
var date = new Date();
var tahun = date.getFullYear();
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, menu.menu(id, A187, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwhatsapp) ,MessageType.text);
}
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, donate.donate(id, A187, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwhatsapp) ,MessageType.text);
}
else if (text == '#donasi'){
var date = new Date();
var tahun = date.getFullYear();
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, info.info(id, A187, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwhatsapp) ,MessageType.text);
}
else if (text == '.foto'){
conn.sendMessage(id, 'kirim !foto cewek/cowok\n\nContoh: !foto cewek' ,MessageType.text);
}
else if (text == 'Jamer'){
conn.sendMessage(id, ' *Iya Jamerl itu ownerku kak... Ada yang bisa dibantu? , Follow Instagram Mimin yah : https://www.instagram.com/jamer.fvnky/*' ,MessageType.text);
}
else if (text == 'Rio){
conn.sendMessage(id, ' *Iyaa Rio itu temennya ownerku kak... Ada yang bisa dibantu?  , Follow Instagram temen Mimin Yah : https://www.instagram.com/rio_edy/*' ,MessageType.text);
}
   if (messageType == 'imageMessage')
   {
      let caption = imageMessage.caption.toLocaleLowerCase()
