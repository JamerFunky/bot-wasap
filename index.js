...
conn.sendMessage(id, ' *Owner Jamer Funky wa.me/6285735054693* ' ,MessageType.text);
}
else if (text == '#help'){
...
conn.sendMessage(id, ' *Iyaa Ghost itu temennya ownerku kak... Ada yang bisa dibantu?  , Follow Instagram adek Mimin Yah : https://instagram.com/clrayyy_*' ,MessageType.text);
}
   if (messageType == 'imageMessage')
   {
      let caption = imageMessage.caption.toLocaleLowerCase()
