...
conn.on('qr', qr =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] Jamerl Graphy QR code ready scan now!`);
});
...
conn.sendMessage(id, ' *Owner JAMER wa.me/6285735054693* ' ,MessageType.text);
}
else if (text == '#help'){
...
conn.sendMessage(id, ' *Iya Jamer itu ownerku kak... Ada yang bisa dibantu? , Follow Instagram Mimin yah : https://instagram.com/jamer.fvnky*' ,MessageType.text);
}
else if (text == 'Clara'){
conn.sendMessage(id, ' *Iyaa Rio itu temennya ownerku kak... Ada yang bisa dibantu?  , Follow Instagram temen Mimin Yah : https://instagram.com/rio_edy*' ,MessageType.text);
}
   if (messageType == 'imageMessage')
   {
      let caption = imageMessage.caption.toLocaleLowerCase()
